        ...
        <form onSubmit={handleSubmit} className="search-bar flex items-center">
            <div className="relative w-full">
                <input
                    ...
                    className="input shadow-lg focus:border-2 border-gray-300 px-5 py-3 rounded-xl w-full transition-all focus:w-full outline-none h-20 text-2xl bg-white/70 hover:bg-white focus:bg-white text-gray-500 font-mono"
                    name="search"
                    type="search"
                ...
                <button type="submit" className="">
                    <svg
                        className="size-6 absolute top-7 right-6 text-gray-500"
                        stroke="currentColor"
                        stroke-width="1.5"
                        viewBox="0 0 24 24"
                        fill="none"
